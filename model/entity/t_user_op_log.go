...
type TUserOpLog struct {
	...
	InterfaceUrl string      `orm:"interfaceUrl"     description:"interfaceUrl"`
	ServerCode   string      `orm:"serverCode"     description:"serverCode"`
	HttpCode     string      `orm:"httpCode"     description:"httpCode"`
	TraceId      string      `orm:"traceId"     description:"traceId"`
