...
func Cors() gin.HandlerFunc {
	return func(context *gin.Context) {
		...
		context.Header("Access-Control-Allow-Headers", "Content-Type,AccessToken,X-CSRF-Token,Authorization,Token,Authorization-Token,xx-device-type,Dev-Id,Lang,Channel,Client-Id,Trace-Id,XXX-Client-Version")
