...
with open("/shell/node_check/health_scores.json", "r", encoding='utf-8') as f:
...
def main():
    siteNames = {
        ...
        "Finland": ["213.159.68.106"],
        "Turkey": ["62.133.63.237"],
    }
    ...
    with open("/shell/node_check/health_scores.json", "w", encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    #main()
    print(Switching_machine_requests("213.159.68.106", "1").text)
    end_time = time.time()
